...
public class ClaimsAndRemoteJWTValidationFilter implements GlobalFilter {
	...
	// will have to add the following to application.yml file
	/*
	default-filters:
    - ClaimsAndRemoteJWTValidationFilter
    
	/*
	public class ClaimsAndRemoteJWTValidationFilter implements AbstractGatewayFilterFactory<ClaimsAndRemoteJWTValidationFilter.Config> {
    ...
    public ClaimsAndRemoteJWTValidationFilter() {
		super(Config.class);
	}

    @Override
    public Config newConfig() {
        return new Config("ClaimsAndRemoteJWTValidationFilter");
    }
